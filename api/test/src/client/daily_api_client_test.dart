...
void main() {
  ...
  group('DailyApiClient', () {
    late http.Client httpClient;
    late DailyApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = DailyApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => DailyApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = DailyApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws DailyApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<DailyApiMalformedResponse>()),
        );
      });

      test(
          'throws DailyApiRequestFailure '
