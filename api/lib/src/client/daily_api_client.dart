...
import 'package:daily_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template daily_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class DailyApiMalformedResponse implements Exception {
  /// {@macro daily_api_malformed_response}
  const DailyApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template daily_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class DailyApiRequestFailure implements Exception {
  /// {@macro daily_api_request_failure}
  const DailyApiRequestFailure({
...
/// {@template daily_api_client}
/// A Dart API client for the daily API.
/// {@endtemplate}
class DailyApiClient {
  /// Create an instance of [DailyApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro daily_api_client}
  DailyApiClient({
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        DailyApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
